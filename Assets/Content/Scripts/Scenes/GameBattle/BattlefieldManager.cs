...
public class BattlefieldManager : MonoBehaviour
{
    ...
    {
        if (Misc.IdManager.GetEntityById(_entityId).TryGetComponent<Cat>(out var cat))
        {
        ...
        if (Misc.IdManager.GetEntityById(_entityId).TryGetComponent<Enemy>(out var enemy))
        {
